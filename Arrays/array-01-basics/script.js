...
// const multipleValues = ["Apple", "Banana", "Orange", "Mango"]; // Holds multiple values

// console.log("multipleValues is an array that holds 4 fruits:", multipleValues);
// console.log(multipleValues.length, "is the length of the array (number of elements)");
...
// // let fruit3 = "Orange";
// // let fruit4 = "Mango";
// console.log(multipleValues[0], "is the first element of the array (index 0)");
// console.log(multipleValues[1], "is the second element of the array (index 1)");
// console.log(multipleValues[2], "is the third element of the array (index 2)");
// console.log(multipleValues[3], "is the fourth element of the array (index 3)");
...
// const ofExample = Array.of('red', 'green', 'blue', 'yellow');
// console.log("  Array.of('red', 'green', 'blue', 'yellow'):", ofExample); // Creates [5, 6, 7] not empty slots

// // Method 5: Array.from()
// console.log("\n5️⃣ Array.from() - Convert to array:");
// const fromString = Array.from("Hello World");
// console.log("  Array.from('Hello World'):", fromString);

// const spreadString = [..."Hello World"];
// console.log("  [...'Hello World']:", spreadString);
...
// console.log("\n1️⃣ Mixed Types:");
// const mixed = [1, "hello", true, null, undefined, {name: "Zeeshan Elahi", age: 24, hobby: "reading"}, [1, 2, 3]];
...
const emptyArray = [];
const emptyObject = {};
console.log("  Is [] an array?", Array.isArray(emptyArray));
console.log("  Is {} an array?", Array.isArray(emptyObject));
/**
