...
// console.log("  Current length:", arrayLength);
...
// console.log("  Updated length:", arrayLength);
...
// console.log("\n1️⃣ Remove elements:");
// const removed2 = months.splice(1, 3); // Remove 3 elements starting at index 2
...
console.log("\n2️⃣ Add elements:");
months.splice(2, 0, "Mar"); // Add "Mar" at index 2 without removing any element
...
months = ["Jan", "Feb", "Mar", "Apr", "May"];
console.log("Array before replacement:", months);
console.log("\n3️⃣ Replace elements:");
months.splice(1, 3, "Nov", "Dec");
console.log("  months.splice(1, 1, 'Nov', 'Dec')");
console.log("  Result:", months);
